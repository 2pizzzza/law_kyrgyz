    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dateOfExpiry', models.TextField()),
                ('placeOfBirth', models.TextField()),
                ('authority', models.TextField()),
                ('dateOfIssue', models.TextField()),
                ('ethnicity', models.TextField()),
                ('personalNumber', models.TextField()),
                ('password', models.CharField(max_length=128)),
                ('middle_name', models.CharField(max_length=100)),
                ('phone_number', models.CharField(default='+996', max_length=100, validators=[django.core.validators.RegexValidator(code='invalid_data', message='Phone Number', regex='^\\+996\\d+$')])),
